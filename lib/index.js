...
(function() {
  ...
  function quarantinePlugin(pluginName, btn) {
    ...
    .catch(function(err) {
      btn.disabled = false;
      btn.textContent = '\u{1F6E1}\uFE0F \u9694\u79BB\u6B64\u63D2\u4EF6\u5E76\u91CD\u8F7D';
  ...
  function enableSafeMode(btn) {
    ...
    .catch(function(err) {
      btn.disabled = false;
      btn.textContent = '\u{1F6A8} \u542F\u7528\u5B89\u5168\u6A21\u5F0F (\u7981\u7528\u5168\u90E8\u7B2C\u4E09\u65B9\u63D2\u4EF6)';
  ...
  function clearQuarantine(btn) {
    ...
    .catch(function(err) {
      btn.disabled = false;
      btn.textContent = '\u{1F504} \u6E05\u7A7A\u9694\u79BB\u540D\u5355';
  ...
  function mountRescue(bootRoot) {
    ...
    header.innerHTML = '\u{1F6E0}\uFE0F DSH-Ext \u6545\u969C\u6025\u6551 (Rescue)';
    ...
    if (failedPlugins.length > 0) {
      failedPlugins.forEach(function(pkg) {
        ...
        qBtn.textContent = '\u{1F6E1}\uFE0F \u9694\u79BB\u6B64\u63D2\u4EF6\u5E76\u91CD\u8F7D';
    ...
    safeBtn.textContent = '\u{1F6A8} \u542F\u7528\u5B89\u5168\u6A21\u5F0F (\u7981\u7528\u5168\u90E8\u7B2C\u4E09\u65B9\u63D2\u4EF6)';
