...
function useResource(route, enabled = true) {
  ...
  return (0, import_react3.useMemo)(() => ({ data, error, loading, reload }), [data, error, loading, reload]);
}
...
var Config = Schema.object({
  ...
  sessionAdmin: Schema.object({
    ...
    attachmentGc: Schema.boolean().default(false).description("On permanent delete, remove attachment blobs no remaining session references. Scans every session log, so it is off by default.")
  }),
                ...
                children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
                  Row,
                  {
                    ...
                    control: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
                      ...
                      {
                        label: t("sessions.gc"),
                        checked: c2.sessionAdmin.attachmentGc,
                        disabled: disabled || !c2.sessionAdmin.enabled,
                        onChange: (next) => {
...
function useTurnInfo(session, turn) {
  ...
  const subscribeKey = (0, import_react12.useCallback)((fn) => {
  ...
  (0, import_react12.useSyncExternalStore)(subscribeKey, getSnapshot);
...
function commit(scope, next) {
  ...
  for (const listener of [...listeners3.get(scope) ?? []]) listener();
}
...
function useTabs(scope) {
  ...
  (0, import_react13.useEffect)(() => {
    ...
    let scoped = listeners3.get(key);
    if (scoped === void 0) {
      scoped = /* @__PURE__ */ new Set();
      listeners3.set(key, scoped);
    }
    scoped.add(listener);
    return () => {
      scoped.delete(listener);
      if (scoped.size === 0) listeners3.delete(key);
    };
  }, [key]);
  const openBound = (0, import_react13.useCallback)((kind, path) => {
    open(key, kind, path);
  }, [key]);
...
function ExplorerPanel(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("div", { "data-dsh-plugin": "dsh-ext", "data-dsh-part": "explorer", style: { display: "flex", flexDirection: "column", gap: 6, flex: 1, minHeight: 0 }, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("div", { style: { overflow: "auto", minHeight: 0, flex: 1 }, children: /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)(ViewBoundary, { children: [
      ...
      active?.kind === "diff" && active.path !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(DiffView, { path: active.path, scope })
    ] }, active?.id ?? "none") })
  ] });
}
...
var ATTACH_ICON = "";
var ATTACH_ICON_CSS_URL = `url("data:image/svg+xml,${encodeURIComponent('<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="none"><path d="M12.4 7.3L7.7 12a2.9 2.9 0 0 1-4.1-4.1l5-5a1.95 1.95 0 0 1 2.75 2.75l-5 5a0.97 0.97 0 0 1-1.38-1.38l4.4-4.4" stroke="black" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round"/></svg>')}")`;
  ...
  trySlot("plus menu attach entry", () => {
    ctx.inject(["commandUi", "inputTriggers"], (scoped) => {
      ...
      commandUi.candidates = async (session, req) => {
        ...
        return [{ name: label, description: hint, icon: ATTACH_ICON, section: attachLabel, value: PLUS_ATTACH_VALUE }, ...items.map((item) => ({ ...item, section: commandLabel }))];
      };
