...
function EditIcon(props) {
  const size2 = props.size ?? 16;
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("svg", { width: size2, height: size2, viewBox: "0 0 16 16", fill: "none", "aria-hidden": "true", children: [
    /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("path", { d: "M9.6 2.9l3.5 3.5L5.4 14.1l-4 .5.5-4L9.6 2.9Z", stroke: "currentColor", strokeWidth: "1.3", strokeLinejoin: "round" }),
    /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("path", { d: "M8.1 4.4l3.5 3.5", stroke: "currentColor", strokeWidth: "1.3", strokeLinejoin: "round" })
  ] });
}
...
function IdeaIcon(props) {
  const size2 = props.size ?? 16;
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("svg", { width: size2, height: size2, viewBox: "0 0 16 16", fill: "none", "aria-hidden": "true", children: [
    /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("rect", { x: "1", y: "1", width: "14", height: "14", rx: "1", fill: "currentColor", opacity: "0.9" }),
    /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
      "path",
      {
...
function UndoIcon(props) {
  const size2 = props.size ?? 16;
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("svg", { width: size2, height: size2, viewBox: "0 0 16 16", fill: "none", "aria-hidden": "true", children: [
    /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("path", { d: "M2.6 3.4v4h4", stroke: "currentColor", strokeWidth: "1.3", strokeLinecap: "round", strokeLinejoin: "round" }),
    /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("path", { d: "M3.1 7.2a5.3 5.3 0 1 1 1.4 5", stroke: "currentColor", strokeWidth: "1.3", strokeLinecap: "round" })
  ] });
}
...
var VIEW_PREFS_KEY = "dsh-dev-tool-ext:review-view-prefs";
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)(
    "button",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(FileIcon, { size: 16, name: baseOf(change.path) }),
        ...
        /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("span", { style: { fontSize: 12, color: token.textMuted, flex: "0 0 auto" }, children: describeChange(change, t) })
      ]
    }
  ) });
}
...
function FolderRow(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)(
    "button",
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(ChevronIcon, { size: 14, open: open3 }),
        /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(FolderIcon, { size: 16, open: open3 }),
...
function ReviewView(props) {
  const t = useT();
  const [filter, setFilter] = (0, import_react12.useState)(() => readViewPrefs().filter);
  const [grouped, setGrouped] = (0, import_react12.useState)(() => readViewPrefs().grouped);
  ...
  if (!props.status.isRepository) {
    return /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("div", { style: { fontSize: 14, color: token.textMuted, padding: "8px 0" }, children: t("explorer.noRepo") });
  }
  if (changes.length === 0) {
    return /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("div", { style: { fontSize: 14, color: token.textMuted, padding: "8px 0" }, children: t("explorer.noChanges") });
  }
        ...
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
            "button",
            {
              ...
              children: grouped ? /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(FilesIcon, { size: 16 }) : /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(FolderIcon, { size: 16, open: false })
            }
          )
        ]
      }
    ),
    filtered.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("div", { style: { fontSize: 14, color: token.textMuted, padding: "8px 0" }, children: t("explorer.noChanges") }) : grouped && tree !== void 0 ? /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("ul", { style: treeStyle, children: /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(FolderNodes, { node: tree, depth: 0, collapsed, onToggle, countsFor: rowCounts, onOpenDiff: props.onOpenDiff }) }) : /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("ul", { style: treeStyle, children: filtered.map((change) => /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
      ReviewRow,
      {
        change,
        label: change.path,
...
function DiffView(props) {
  ...
  if (changedRows === 0) {
    return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("div", { style: { fontSize: 14, color: token.textMuted }, children: t("explorer.noDiff") });
  }
...
var ViewBoundary = class extends import_react14.Component {
  ...
  render() {
    if (this.state.failed) {
      return /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { style: { fontSize: 12, color: token.textMuted, padding: "8px 0" }, children: [
        "[dsh-dev-tool-ext] view crashed \u2014 close this tab and reopen it.",
        this.state.message.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { style: { marginTop: 6, color: token.danger, fontFamily: "ui-monospace, monospace", whiteSpace: "pre-wrap", wordBreak: "break-word" }, children: this.state.message })
      ] });
    }
...
function TreeRow(props) {
  ...
  const row = /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(
    "button",
    {
      ...
      style: { ...rowStyle, paddingLeft: 4 + depth * INDENT },
      children: [
        entry.kind === "directory" ? /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(ChevronIcon, { size: 14, open: open3 }) : /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("span", { "aria-hidden": "true", style: { width: 14, flex: "0 0 auto" } }),
        entry.kind === "directory" ? /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(FolderIcon, { size: 16, open: open3 }) : /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(FileIcon, { size: 16, name: entry.name }),
...
function FilesView(props) {
  ...
  if (tree.data === void 0) {
    return /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { style: { fontSize: 14, color: token.textMuted }, children: t("common.loading") });
  }
...
function EditorView(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: 4 }, children: [
        ...
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
            import_dsh_client_ui_primitives.Menu,
            {
              ...
              portal: true,
              items: [
                { id: "explorer", label: t("explorer.openWith.explorer"), icon: /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(FolderIcon2, { size: 14 }) },
                { id: "vscode", label: t("explorer.openWith.vscode"), icon: /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(VscodeIcon, { size: 14 }) },
                { id: "idea", label: t("explorer.openWith.idea"), icon: /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(IdeaIcon, { size: 14 }) }
              ],
              anchor: /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(
                "button",
                {
                  ...
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("span", { children: t("turn.open") }),
                    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(ChevronIcon, { size: 11, open: menuOpen })
                  ]
                }
              )
            }
    ...
    failure !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(import_dsh_client_ui_primitives.Toast, { text: failure.text, onDone: () => {
      setFailure(void 0);
    } }, failure.seq)
  ] });
}
        ...
        props.tabs.map((tab) => {
          ...
          return /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(
            "div",
            {
              ...
              children: [
                tab.kind === "files" && /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(FilesIcon, { size: 16 }),
                (tab.kind === "review" || tab.kind === "diff") && /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(GitIcon, { size: 16 }),
                tab.kind === "editor" && /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(FileIcon, { size: 16, name: baseOf2(tab.path ?? "") }),
                ...
                /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
                  "button",
                  {
                    ...
                    children: /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(CloseIcon, { size: 12 })
                  }
                )
              ]
            },
          ...
          import_dsh_client_ui_primitives.Menu,
          {
            ...
            anchor: /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
              "button",
              {
                ...
                children: /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(PlusIcon, { size: 16 })
              }
            )
          }
        )
...
function ExplorerPanel(props) {
  ...
  (0, import_react14.useEffect)(() => bindPanelTabs(tabScope), [tabScope]);
  ...
  return (
    ...
    /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { "data-dsh-plugin": "dsh-dev-tool-ext", "data-dsh-part": "explorer", style: { display: "flex", flexDirection: "column", gap: 6, flex: 1, minHeight: 0 }, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { style: { overflow: "auto", minHeight: 0 }, children: /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(ViewBoundary, { children: [
        active?.kind === "review" && (status.data === void 0 ? /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { style: { fontSize: 14, color: token.textMuted }, children: t("common.loading") }) : /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(ReviewView, { status: status.data, onOpenDiff: (path) => {
...
function TurnChangesCard(props) {
  ...
  const uncuttable = detailReady && detail.data?.undoAnchorSeq === void 0;
    ...
    dialog !== "none" && /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(
      import_dsh_client_ui_primitives2.Modal,
      {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: 10, fontSize: 12 }, children: [
          ...
          uncuttable && /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(Notice, { kind: "error", children: t("turn.firstTurnNoFork") }),
          error !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(Notice, { kind: "error", children: error })
        ] })
      }
    ),
    failure !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(import_dsh_client_ui_primitives2.Toast, { text: failure.text, onDone: () => {
      setFailure(void 0);
    } }, failure.seq)
  ] });
}
...
function UserEditBubble(props) {
  ...
  if (editing) {
    return /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("div", { "data-dsh-plugin": "dsh-dev-tool-ext", "data-dsh-part": "user-edit", style: { display: "flex", flexDirection: "column", gap: 8, margin: "6px 0 10px" }, children: [
  ...
  trySlot("turn changes card", () => {
    ctx.inject(["slots", "sessions", "workspaces"], (scope) => {
      ...
      scope.slots.inject("conversation.chat.turnTail", () => scope.slots.register({
        ...
        select: (owner) => {
          const sessionId2 = String(owner.sessionId ?? "");
          ...
          if (Number.isSafeInteger(turn) && status !== void 0) {
            ...
            lastTurn.set(sessionId2, value);
            return value;
          }
          return lastTurn.get(sessionId2) ?? null;
        },
  ...
  trySlot("explorer open-editor launcher", () => {
    ctx.slots.inject("conversation.session.header.utilities", () => ctx.slots.register({
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)(import_jsx_runtime20.Fragment, { children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(import_dsh_client_ui_primitives4.Toast, { text: failure.text, onDone: () => {
          setFailure(void 0);
        } }, failure.seq)
      ] });
    }));
