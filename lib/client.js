...
var Config = Schema.object({
  ...
  commandReview: Schema.object({
    ...
    model: Schema.string().default("deepseek-v4-flash").description("Reviewer model id."),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { style: { overflowX: "clip", minHeight: 380, paddingTop: 14, paddingLeft: 1, paddingRight: 1 }, children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
      "div",
      {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(SettingsBoundary, { children: [
          ...
          tab === "review" && /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(import_jsx_runtime6.Fragment, { children: [
            /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(
              Section,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: { padding: "10px 0 14px" }, children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
              Section,
              {
                ...
                children: /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: { padding: "12px 0 16px" }, children: [
                  /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { style: { display: "flex", flexWrap: "wrap", gap: 8, marginBottom: 14 }, children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
              Section,
              {
                ...
                children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { style: { padding: "6px 0 12px" }, children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(AuditPanel, { enabled: c2.commandReview.enabled }) })
              }
            )
          ] }),
...
function useTurnInfo(session, turn) {
  ...
  const subscribeKey = (0, import_react11.useCallback)((fn) => {
  ...
  (0, import_react11.useSyncExternalStore)(subscribeKey, getSnapshot);
...
function useTabs(scope) {
  ...
  const openBound = (0, import_react12.useCallback)((kind, path) => {
    open(key, kind, path);
  }, [key]);
  const selectBound = (0, import_react12.useCallback)((id) => {
    select(key, id);
  }, [key]);
  const closeBound = (0, import_react12.useCallback)((id) => {
    close(key, id);
  }, [key]);
...
var CardBoundary = class extends import_react14.Component {
...
function TurnChangesCard(props) {
  ...
  const [dialog, setDialog] = (0, import_react14.useState)("none");
  const [busy, setBusy] = (0, import_react14.useState)(false);
  const [error, setError] = (0, import_react14.useState)(void 0);
  const [openMenuFor, setOpenMenuFor] = (0, import_react14.useState)(null);
  const [failure, setFailure] = (0, import_react14.useState)(void 0);
...
function ComposerImages(props) {
  ...
  const t = useT();
  const [dragging, setDragging] = (0, import_react16.useState)(void 0);
  const [over, setOver] = (0, import_react16.useState)(void 0);
  const [fileOver, setFileOver] = (0, import_react16.useState)(false);
  const [notice, setNotice] = (0, import_react16.useState)(void 0);
  ...
  const commitMove = (0, import_react16.useCallback)((from2, to) => {
  ...
  const nudge = (0, import_react16.useCallback)((id, delta) => {
  ...
  const pick2 = (0, import_react16.useCallback)(() => {
    fileInput.current?.click();
  }, []);
  const insertText = (0, import_react16.useCallback)((text) => {
  ...
  (0, import_react16.useEffect)(() => provideImagePicker({ pick: pick2, insertText }), [pick2, insertText]);
  const onPicked = (0, import_react16.useCallback)(async (files) => {
...
var ContextType = (0, import_react17.createContext)(DEFAULT_CONTEXT_VALUE);
var Provider = ContextType.Provider;
var useDiffSettings = function() {
  return (0, import_react17.useContext)(ContextType);
};
...
var CodeCell$1 = (0, import_react17.memo)(CodeCell);
...
var UnifiedChange$1 = (0, import_react17.memo)(UnifiedChange);
...
function useCallbackOnSide(side, setHover, change, customCallbacks) {
  var markHover = (0, import_react17.useCallback)(function() {
    return setHover(side);
  }, [side, setHover]), unmarkHover = (0, import_react17.useCallback)(function() {
    return setHover("");
  }, [setHover]);
  return (0, import_react17.useMemo)(function() {
...
var SplitChange$1 = (0, import_react17.memo)(SplitChange);
...
function Diff(props) {
  ...
  }, []), hideGutter = "none" === gutterType, monotonous = "add" === diffType || "delete" === diffType, onTableMouseDown = "split" === viewType && !monotonous && optimizeSelection ? enableColumnSelection : noop, cols = (0, import_react17.useMemo)(function() {
  ...
  }, [viewType, monotonous, hideGutter]), settingsContextValue = (0, import_react17.useMemo)(function() {
...
var index = (0, import_react17.memo)(Diff);
...
function ReviewRow(props) {
  ...
  const statusColor = change.untracked ? token.textMuted : statusLetter === "A" ? token.success : statusLetter === "D" ? token.danger : token.accent;
...
function FolderNodes(props) {
  ...
  for (const dir of dirs) {
    rows.push(/* @__PURE__ */ (0, import_jsx_runtime14.jsx)(FolderRow, { node: dir, depth, collapsed: props.collapsed, onToggle: props.onToggle, countsFor: props.countsFor }, dir.path));
    if (!props.collapsed.has(dir.path)) {
      rows.push(
        ...
        /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("ul", { style: treeStyle, children: /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(FolderNodes, { node: dir, depth: depth + 1, collapsed: props.collapsed, onToggle: props.onToggle, countsFor: props.countsFor, onOpenDiff: props.onOpenDiff }) }) }, `children-${dir.path}`)
      );
    }
  }
...
function ReviewView(props) {
  const t = useT();
  const [filter, setFilter] = (0, import_react18.useState)(() => readViewPrefs().filter);
  const [grouped, setGrouped] = (0, import_react18.useState)(() => readViewPrefs().grouped);
  const [collapsed, setCollapsed] = (0, import_react18.useState)(() => /* @__PURE__ */ new Set());
  ...
  const sideCounts = (0, import_react18.useMemo)(() => ({
    all: changes.length,
    staged: changes.filter((change) => change.staged).length,
    unstaged: changes.filter((change) => !change.staged).length
  }), [changes]);
  const tree = (0, import_react18.useMemo)(() => grouped ? buildTree(filtered) : void 0, [grouped, filtered]);
  const rowCounts = (0, import_react18.useMemo)(() => (change) => countsFor(change, filter), [filter]);
  const onToggle = (0, import_react18.useMemo)(() => (path) => {
  ...
  if (changes.length === 0) {
    return /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("div", { style: { fontSize: 12, color: token.textMuted, padding: "16px 8px", textAlign: "center" }, children: t("explorer.noChanges") });
  }
    ...
    /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)(
      "div",
      {
        ...
        children: [
            ...
            return /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)(
              "button",
              {
                ...
                style: {
                  ...
                  fontWeight: active ? 600 : 400,
                  background: active ? "var(--dsw-alias-state-business-primary, #2563eb)" : "var(--dsw-alias-bg-layer-2, rgba(125, 125, 125, 0.08))",
                  borderColor: active ? "var(--dsw-alias-state-business-primary, #2563eb)" : token.border,
          ...
          /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("span", { style: { flex: 1 } }),
          /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(
            "button",
            {
              type: "button",
              ...
              children: grouped ? /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(FilesIcon, { size: 15 }) : /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(FolderIcon2, { size: 15, open: false })
            }
          )
        ]
      }
    ),
    filtered.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("div", { style: { fontSize: 13, color: token.textMuted, padding: "16px 8px", textAlign: "center" }, children: t("explorer.noChanges") }) : grouped && tree !== void 0 ? /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("ul", { style: treeStyle, children: /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(FolderNodes, { node: tree, depth: 0, collapsed, onToggle, countsFor: rowCounts, onOpenDiff: props.onOpenDiff }) }) : /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("ul", { style: treeStyle, children: filtered.map((change) => /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(
      ReviewRow,
      {
        change,
        label: change.path,
...
function DiffView(props) {
  ...
  const language = grammarFor(props.path);
  const patch = (0, import_react19.useMemo)(() => {
  ...
  const parsedFile = (0, import_react19.useMemo)(() => {
  ...
  const oldLineCount = (0, import_react19.useMemo)(() => (oldSource ?? "").split("\n").length, [oldSource]);
  const [expanded, setExpanded] = (0, import_react19.useState)(() => /* @__PURE__ */ new Set());
  const onExpand = (0, import_react19.useMemo)(() => (start) => {
...
function ProjectPathBar(props) {
  ...
  const handleCopy = (0, import_react20.useCallback)((e) => {
    e.stopPropagation();
    if (!fullPath) return;
  ...
  const handleOpenFolder = (0, import_react20.useCallback)((e) => {
    e.stopPropagation();
...
var ViewBoundary = class extends import_react20.Component {
  state = { failed: false, message: "" };
  static getDerivedStateFromError(error) {
    return { failed: true, message: error.message };
  }
...
function FilesView(props) {
  ...
  const toggle = (0, import_react20.useCallback)((path) => {
...
function ImageViewer(props) {
  const [dimensions, setDimensions] = (0, import_react20.useState)(null);
...
function EditorView(props) {
  ...
  const [failure, setFailure] = (0, import_react20.useState)(void 0);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: 4 }, children: [
    ...
    failure !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(import_dsh_client_ui_primitives4.Toast, { text: failure.text, onDone: () => {
      setFailure(void 0);
    } }, failure.seq)
  ] });
}
...
function ExplorerPanel(props) {
  ...
  (0, import_react20.useEffect)(() => bindPanelTabs(tabScope), [tabScope]);
  ...
  const reloadRef = (0, import_react20.useRef)(status.reload);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("div", { "data-dsh-plugin": "dsh-ext", "data-dsh-part": "explorer", style: { display: "flex", flexDirection: "column", gap: 6, flex: 1, minHeight: 0 }, children: [
        ...
        status.data?.branch !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("span", { style: { maxWidth: 88, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }, children: status.data.branch }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("div", { style: { overflow: "auto", minHeight: 0, flex: 1 }, children: /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)(ViewBoundary, { children: [
      active?.kind === "review" && (status.data === void 0 ? /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("div", { style: { fontSize: 12, color: token.textMuted, padding: "16px 8px", textAlign: "center" }, children: t("common.loading") }) : /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(ReviewView, { status: status.data, onOpenDiff: (path) => {
    ...
    ctx.slots.inject("conversation.input.left", () => ctx.slots.register({
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(
        "button",
        {
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(PaperclipIcon, {})
        }
      );
    }));
  });
  ...
  trySlot("balance badge", () => {
    ctx.inject(["slots", "modelDirectories", "sessions"], (scope) => {
      ...
      scope.slots.inject("conversation.input.right", () => scope.slots.register({
        ...
        const config = useClientConfig();
        const [cardEl, setCardEl] = (0, import_react24.useState)(null);
        const anchorRef = (0, import_react24.useRef)(null);
        const currentSessionId = (0, import_react24.useSyncExternalStore)(
          (0, import_react24.useCallback)((fn) => sessionsService?.list?.subscribe ? sessionsService.list.subscribe(fn) : () => {
          }, [sessionsService]),
          (0, import_react24.useCallback)(() => props.sessionId ?? sessionsService?.list?.getSnapshot?.()?.current, [props.sessionId, sessionsService])
        );
        const directory = (0, import_react24.useMemo)(() => {
        ...
        const modelSnap = (0, import_react24.useSyncExternalStore)(
          (0, import_react24.useCallback)((fn) => directory?.subscribe ? directory.subscribe(fn) : () => {
          }, [directory]),
          (0, import_react24.useCallback)(() => directory?.getSnapshot ? directory.getSnapshot() : null, [directory])
        );
        const findCard = (0, import_react24.useCallback)(() => {
        ...
        const setAnchor = (0, import_react24.useCallback)((node) => {
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)(import_jsx_runtime19.Fragment, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("span", { ref: setAnchor, style: { display: "none" } }),
          cardEl && cardEl.isConnected ? (0, import_react_dom.createPortal)(/* @__PURE__ */ (0, import_jsx_runtime19.jsx)(BalanceBadge, { cardEl }), cardEl) : null
        ] });
      }));
    });
  });
    ...
    ctx.slots.inject("conversation.input.left", () => ctx.slots.register({
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(ShieldCheckIcon, { size: 13 }),
            t("review.autoChip")
          ]
        }
      );
  ...
  trySlot("turn changes card", () => {
    ctx.inject(["slots", "sessions", "workspaces"], (scope) => {
      ...
      scope.slots.inject("conversation.chat.turnTail", () => scope.slots.register({
        ...
        const workspaceItems = props.useWorkspaces?.((state) => state.items);
        if (config === void 0) {
          return /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(CardBoundary, { children: /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(
            TurnChangesCard,
            {
              sessionId: String(props.sessionId),
...
function registerOpenEditorLauncher(ctx) {
  trySlot("explorer open-editor launcher", () => {
    ctx.slots.inject("conversation.session.header.utilities", () => ctx.slots.register({
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)(import_jsx_runtime19.Fragment, { children: [
        /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("div", { style: { position: "relative", display: "inline-block" }, children: [
          /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)(
            "button",
            {
              ...
              children: [
                editorType === "explorer" ? /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(FolderIcon, { size: 16 }) : editorType === "idea" ? /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(IdeaIcon, { size: 16 }) : /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(VscodeIcon, { size: 16 }),
                /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("span", { style: { fontSize: 13 }, children: t("explorer.openLabel") })
              ]
            }
          ),
          dropdownOpen && /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)(import_jsx_runtime19.Fragment, { children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(
              "div",
              {
                ...
                ].map(({ type, icon: Icon }) => /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)(
                  "button",
                  {
                    type: "button",
                    disabled: busy,
                    ...
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(Icon, { size: 16 }),
                      /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("span", { style: { flex: 1 }, children: t(`explorer.openWith.${type}`) }),
                      editorType === type && /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("span", { style: { fontSize: 14, color: "var(--dsw-alias-brand-primary, #5c9fff)" }, children: "\u2713" })
                    ]
                  },
                  type
                ))
        ...
        /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(import_dsh_client_ui_primitives5.Toast, { text: failure.text, onDone: () => {
          setFailure(void 0);
        } }, failure.seq)
      ] });
    }));
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)(import_jsx_runtime19.Fragment, { children: [
        /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(import_dsh_client_ui_primitives5.IconTrashOutline16, { size: props.wide ? 16 : 18 }),
              props.wide && /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("span", { style: { whiteSpace: "nowrap", overflow: "hidden" }, children: t("sessions.trashButton") })
            ]
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(TrashModal, { open: open3, onClose: () => {
          setOpen(false);
        } })
      ] });
    }));
