...
var STORAGE_PREFIX = "dsh-dev-tool-ext:side-panel-tabs:";
var LEGACY_STORAGE_KEY = "dsh-dev-tool-ext:side-panel-tabs";
...
function useTabs(scope) {
  ...
  const openBound = (0, import_react10.useCallback)((kind, path) => {
    open(key, kind, path);
  }, [key]);
  const selectBound = (0, import_react10.useCallback)((id) => {
    select(key, id);
  }, [key]);
  const closeBound = (0, import_react10.useCallback)((id) => {
    close(key, id);
  }, [key]);
...
function FolderRow(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)(
    "button",
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(ChevronIcon, { size: 12, open: open3 }),
        /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(FolderIcon, { size: 15, open: open3 }),
...
function TreeRow(props) {
  ...
  const row = /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(
    "button",
    {
      ...
      style: { ...rowStyle, paddingLeft: 4 + depth * INDENT },
      children: [
        entry.kind === "directory" ? /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(ChevronIcon, { size: 12, open: open3 }) : /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("span", { "aria-hidden": "true", style: { width: 12, flex: "0 0 auto" } }),
        entry.kind === "directory" ? /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(FolderIcon, { size: 15, open: open3 }) : /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(FileIcon, { size: 15, name: entry.name }),
  ...
  return (
    ...
    /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { "data-dsh-plugin": "dsh-dev-tool-ext", "data-dsh-part": "explorer", style: { display: "flex", flexDirection: "column", gap: 6, flex: 1, minHeight: 0 }, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { style: { overflow: "auto", minHeight: 0 }, children: /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(ViewBoundary, { children: [
        active?.kind === "review" && (status.data === void 0 ? /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { style: { fontSize: 13, color: token.textMuted }, children: t("common.loading") }) : /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(ReviewView, { status: status.data, onOpenDiff: (path) => {
          openPanelTab("diff", path);
        } })),
        active?.kind === "files" && /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
          FilesView,
          {
            workspace: props.workspace,
            sessionId: props.sessionId,
            onOpenFile: (path) => {
              openPanelTab("editor", path);
            }
          }
        ),
...
function Disclosure(props) {
  const [open3, setOpen] = (0, import_react15.useState)(props.defaultOpen === true);
  return /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { style: { paddingTop: 4 }, children: [
    ...
    open3 && /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("div", { style: { paddingTop: 8 }, children: props.children })
  ] });
}
...
function MessageRestoreAction(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)(import_jsx_runtime15.Fragment, { children: [
    ...
    open3 && /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(
      import_dsh_client_ui_primitives2.Modal,
      {
        ...
        footer: /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)("div", { style: { display: "flex", justifyContent: "flex-end", gap: 8 }, children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(
            ...
            {
              type: "button",
              disabled: busy || preview === void 0 || preview.affected.length === 0,
              onClick: () => {
                void restore();
              },
              style: { ...buttonStyle, borderColor: token.danger, color: token.danger },
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: 10, fontSize: 12 }, children: [
          ...
          preview !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)(import_jsx_runtime15.Fragment, { children: [
            preview.workspace !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("div", { style: { fontSize: 11, color: token.textMuted }, children: t("cp.restoreWorkspace", { path: preview.workspace }) }),
            /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("p", { style: { margin: 0, lineHeight: 1.55, color: token.textSecondary }, children: preview.affected.length === 0 ? t("cp.restoreAnswerNoop") : t("cp.restoreAnswerHint", { n: preview.affected.length }) }),
...
function ModelPicker(props) {
  ...
  const state = (0, import_react21.useSyncExternalStore)(
  ...
  const [open3, setOpen] = (0, import_react21.useState)(false);
  ...
  const visible = (0, import_react21.useMemo)(() => state.groups.map((group) => ({
    group,
...
function useLocalToggle(key, fallback2) {
  ...
  const [open3, setOpen] = (0, import_react22.useState)(read3);
  const write = (next) => {
    setOpen(next);
    try {
