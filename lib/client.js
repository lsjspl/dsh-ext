...
function ExplorerPanel(props) {
  ...
  const reloadRef = (0, import_react9.useRef)(status.reload);
  ...
  return (
    ...
    /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { "data-dsh-plugin": "dsh-dev-tool-ext", "data-dsh-part": "explorer", style: { display: "flex", flexDirection: "column", gap: 6, flex: 1, minHeight: 0 }, children: [
...
function ComposerImages(props) {
  ...
  const [notice, setNotice] = (0, import_react11.useState)(void 0);
  ...
  const insertText = (0, import_react11.useCallback)((text) => {
  ...
  (0, import_react11.useEffect)(() => provideImagePicker({ pick, insertText }), [pick, insertText]);
  const onPicked = (0, import_react11.useCallback)(async (files) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)(
    "div",
    {
      ...
      children: [
        ...
        notice !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("div", { role: "status", style: { fontSize: 11, color: token.textMuted, paddingBottom: 4 }, children: notice })
      ]
    }
  );
}
...
function SidePanel(props) {
  ...
  const dragging = (0, import_react14.useRef)(false);
  ...
  const onHandleDown = (0, import_react14.useCallback)((event) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(ExplorerPanel, { sessionId: session, workspace: props.workspace })
      ]
    }
  );
}
...
function ModelPicker(props) {
  ...
  const state = (0, import_react15.useSyncExternalStore)(
    (0, import_react15.useCallback)((fn) => directory.subscribe(fn), [directory]),
    (0, import_react15.useCallback)(() => directory.getSnapshot(), [directory])
  );
  const [open2, setOpen] = (0, import_react15.useState)(false);
  const [pane, setPane] = (0, import_react15.useState)("root");
  const [collapsed, setCollapsed] = (0, import_react15.useState)(readCollapsed);
  const [filter, setFilter] = (0, import_react15.useState)("");
  const lastAction = (0, import_react15.useRef)("load");
  const rootRef = (0, import_react15.useRef)(null);
  const triggerRef = (0, import_react15.useRef)(null);
  const itemRefs = (0, import_react15.useRef)([]);
  const id = (0, import_react15.useId)();
  const current = state.current;
  const currentModel = (0, import_react15.useMemo)(() => {
  ...
  const effortChoices = (0, import_react15.useMemo)(() => {
  ...
  const reload = (0, import_react15.useCallback)(() => {
  ...
  const visible = (0, import_react15.useMemo)(() => state.groups.map((group) => ({
    group,
...
function registerImageTrigger(ctx) {
  trySlot("composer attach button", () => {
    ctx.slots.inject("conversation.input.left", () => ctx.slots.register({
      ...
      const config = useClientConfig();
      const input = props.useInput((state) => state);
      const ready = (0, import_react16.useSyncExternalStore)(subscribeImagePicker, hasImagePicker, () => false);
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(
        "button",
        {
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(PaperclipIcon, {})
        }
      );
    }));
  });
...
function useLocalToggle(key, fallback2) {
  ...
  const [open2, setOpen] = (0, import_react16.useState)(read2);
  const write = (next) => {
    setOpen(next);
    try {
